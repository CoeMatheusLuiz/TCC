				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{asset('site/imagens/home/logo.png')}}" alt="" /></a>
						</div>
							...
							<div class="col-sm-4">
								<div class="product-image-wrapper">
									<div class="single-products">
                                            ...
                                            <img src="{{Storage::disk('local')->url('produto_imagens/'.$produto->imagem)}}" />
												<h2>{{$produto->preco}}</h2>
												<p>{{$produto->nome}}</p>
                        ...
                        <div class="tab-pane fade active in" id="tshirt" >
                            <div class="col-sm-3">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{asset('site/imagens/home/gallery1.jpg')}}" alt="" />
                                            <h2>$56</h2>
