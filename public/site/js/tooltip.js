...
//----------------------------------------------------------------------------------------------------
	...
	this.bgColor = "rgba(0, 0, 0, 0.7)";			// background color
	this.textFont = "Comic Sans MS";	// text font family
	this.textSize = 13;					// text font size (pixels)
	this.textColor = "#00FF00";			// text color
	this.textAlign = "center";			// text alignment: "left", "right" or "center"
	this.border = "2px solid #f79a56";	// border (CSS spec: size style color, e.g. "1px solid #D00000")
